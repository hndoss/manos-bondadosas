# Generated by Django 3.0.6 on 2020-06-14 05:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beneficiaries', models.ManyToManyField(blank=True, related_name='projects', to='people.Beneficiary')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='projects', to='projects.Category')),
                ('collaborators', models.ManyToManyField(blank=True, related_name='projects', to='people.Collaborator')),
            ],
        ),
        migrations.CreateModel(
            name='Status',
